    ...
    <article>
        ...
        <?php if (getPostListHeaderImageStyle($this->fields->postListHeaderImageStyle, $this->options->postListHeaderImageStyle) == 'max' && $headerImage): ?>
            <div class="header-img mb-4">
                <a <?php if ($this->options->headerImageStyle == 'rounded-corners') echo 'class="rounded"'; ?> href="<?php $this->permalink(); ?>" aria-hidden="true" aria-label="<?php _e('文章头图'); ?>" style="background-image: url(<?php echo $headerImage; ?>);" tabindex="-1"></a>
            </div>
        <?php endif; ?>
            ...
            <header class="mb-4">
                ...
                <div class="post-info mt-2">
                    ...
                    <span class="ml-2" title="<?php _e('作者'); ?>" data-toggle="tooltip" data-placement="top">
                        ...
                        <a href="<?php $this->author->permalink(); ?>" class="mr-2" title="<?php _e('作者'); ?><?php $this->author(); ?>">
                            <?php $this->author(); ?>
                        </a>
                    </span>
                        ...
                        <div class="more-link-wrapper">
                            <div>
                                ...
                                <a href="<?php $this->permalink() ?>#comments" class="comment-count">
                                    ...
                                    <b><?php $this->commentsNum(_e('%d 评论')); ?></b>
                                </a>
                            </div>
